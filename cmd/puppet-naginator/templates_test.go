...
var puppetdbServices = []puppetquery.Resource{
	...
	puppetquery.Resource{
		Certname:   "www26.jimdo-server.com",
		Type:       "Nagios_service",
		Title:      "sqldump_activity_log on www26.jimdo-server.com",
		Exported:   true,
		Sourcefile: "/var/lib/puppet/environments/production/modules/periodicnoise/manifests/monitored_cron.pp",
		Sourceline: 90,
		Parameters: map[string]interface{}{
			"freshness_threshold": 2.7648e+06,
			"host_name":           "www26.jimdo-server.com",
			"service_description": "sqldump_activity_log",
			"use": "critical-passive-service-noflapping-nopager",
		},
	},
}
...
define service {
	## --PUPPET_NAME-- (called '_naginator_name' in the manifest)                sqldump_activity_log on www26.jimdo-server.com
	host_name                      www26.jimdo-server.com
	use                            critical-passive-service-noflapping-nopager
	service_description            sqldump_activity_log
	freshness_threshold            2764800
}
`
